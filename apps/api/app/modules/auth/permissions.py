...
CONVERSATIONS_TAG = "conversations:tag"
TAGS_MANAGE = "tags:manage"
CONVERSATIONS_BULK_PAUSE = "conversations:bulk_pause"
...
ALL_PERMISSIONS: frozenset[str] = frozenset(
    {
        ...
        ACCOUNTS_MANAGE, API_KEYS_MANAGE, ANALYTICS_READ,
        CONVERSATIONS_TAG, TAGS_MANAGE, CONVERSATIONS_BULK_PAUSE,
    }
)
...
_SUPERVISOR = _AGENT | frozenset(
    {
        ...
        ANALYTICS_READ,
        TAGS_MANAGE, CONVERSATIONS_BULK_PAUSE,
    }
)
